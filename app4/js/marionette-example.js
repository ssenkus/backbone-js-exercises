...
app.module('App', function(module, App, Backbone, Marionette, $, _) {
    ...
    module.BookItemView = Marionette.ItemView.extend({
        ...
        onRender: function() {
            console.log('BookItemView: onRender >>> ' + this.model.get('title'))
        },
        onShow: function() {
            console.log('BookItemView: onShow >>> ' + this.model.get('title'))
        }
    });
    ...
    module.BookCollectionView = Marionette.CollectionView.extend({
        ...
        initialize: function() {
            console.log('BookCollectionView: initialize')
        },
        onRender: function() {
            console.log('BookCollectionView: onRender')
        },
        onShow: function() {
            console.log('BookCollectionView: onShow')
        }
    });
    ...
    module.AppLayoutView = Marionette.Layout.extend({
        ...
        onRender: function() {
            ...
            var bookArray = [];
            bookArray.push({title: 'Wolf',
                authorLast: 'Harrison',
                authorFirst: 'Jim'});
            bookArray.push({title: 'The Theory and Practice of Rivers',
                authorLast: 'Snyder',
                authorFirst: 'Gary'});
            bookArray.push({title: 'Weather Central',
                authorLast: 'Kooser',
                authorFirst: 'Ted'});
            bookArray.push({title: 'Losing Season',
                authorLast: 'Ridl',
                authorFirst: 'Jack'});
            bookArray.push({title: 'Mornings Like This',
                authorLast: 'Dillard',
                authorFirst: 'Annie'});
            bookArray.push(new module.BookModel())
